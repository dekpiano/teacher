    ...
    <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
            <li class=" <?=$this->uri->segment(1) == 'Home' ? 'active' : '' ?>">
                <a class="Loader" href="<?=base_url('Home');?>"> <i class="icon-home"></i>หน้าแรก </a>
            </li>
        </ul>
            ...
            <!-- <li><a  href="#TeacherJob" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="TeacherJob"
                    ...
                    <li
                        ...
                        <a class="Loader" href="<?=base_url('Teaching/CheckHomeRoomMain');?>">เช็ตชื่อหน้าประตูโรงเรียน</a>
                    </li>
                    <li class="<?=$this->uri->segment(2) == 'CheckTeaching' ? 'active' : '' ?>"><a class="Loader" href="<?=base_url('Teaching/CheckTeaching');?>">เช็ดชื่อการสอน</a></li>
                    <li class="<?=$this->uri->segment(2) == 'RoomOnlineMain' ? 'active' : '' ?>"><a class="Loader" href="<?=base_url('Teaching/RoomOnlineMain');?>">ห้องเรียนออนไลน์</a></li>
                </ul>
            </li> -->
            ...
            <li><a  href="#TeacherLarn" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="TeacherLarn"
                    ...
                    <li
                        ...
                        <a class="Loader" href="<?=base_url('Teaching/CheckHomeRoomMain');?>">เช็ตชื่อโฮมรูม</a>
                    </li>
                    <!-- <li class="<?=$this->uri->segment(2) == 'CheckTeaching' ? 'active' : '' ?>"><a class="Loader" href="<?=base_url('Teaching/CheckTeaching');?>">เช็ดชื่อการสอน</a></li>
                    <li class="<?=$this->uri->segment(2) == 'RoomOnlineMain' ? 'active' : '' ?>"><a class="Loader" href="<?=base_url('Teaching/RoomOnlineMain');?>">ห้องเรียนออนไลน์</a></li> -->
                </ul>
            ...
            <li class=" <?=$this->uri->segment(1) == 'Course' ? 'active' : '' ?>">
                ...
                <ul id="exampledropdownDropdown"
                    ...
                    <li
                        ...
                        <a class="Loader" href="<?=base_url('Course/CheckPlan');?>"> <i class="icon-flask"></i>ตรวจงาน /
                            ดาวน์โหลด </a>
                    </li>
                    <li
                        class="<?=$this->uri->segment(1) == 'Course' && $this->uri->segment(2) == 'ReportPlan' ? 'active' : '' ?>">
                        <a class="Loader" href="<?=base_url('Course/ReportPlan');?>"> <i class="fa fa-print"
            ...
            <li>
                ...
                <ul id="HelpStudent"
                    ...
                    <li class="<?=$this->uri->segment(2) == 'Main' ? 'active' : '' ?>">
                        <a class="Loader" href="<?=base_url('SupStd/Main');?>">เยี่ยมบ้าน / SDQ</a>
                    </li>
                    ...
                    <li class="<?=$this->uri->segment(2) == 'CheckWorkManager' ? 'active' : '' ?>">
                        <a class="Loader" href="<?=base_url('SupStd/CheckWorkManager/2565');?>">หัวหน้างาน</a>
                    </li>
                    <!-- <li class="<?=$this->uri->segment(2) == 'CheckWorkExecutive' ? 'active' : '' ?>">
                        <a class="Loader" href="<?=base_url('SupStd/CheckWorkExecutive');?>">ผู้บริหาร</a>
                    </li> -->
                    <?php endif; ?>
                </ul>
            </li>
